...
function getAssistantSystemPrompt(params?: { aiInstructions?: string | null }) {
  const base = [
    ...
    'Use the "create_artifact" tool when the user clearly requests a structured deliverable that should live in a side panel, such as:',
    ...
    '',
    'When you detect a structured-deliverable request, you MUST:',
